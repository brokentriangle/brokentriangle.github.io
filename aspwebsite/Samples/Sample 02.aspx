   ...
   style="   background-color: black; 
    ...
    <form id="form1" runat="server">
        ...
        <p class="auto-style2">
          ...
          <div class="tails" style="padding: 10px 0;padding-bottom: 10px;background-color: #fff;color: #121212;">
            <div class="fromleft" style="max-width: 600px;margin: 0 auto;padding: 0 50px;">
                ...
                <p class="auto-style1">
                <asp:Image id="VD" runat="server" ImageUrl="~/images/VDFlashcards_1280w.png" ImageAlign="Middle"/>       
                </p>
          ...
          <div class="tails" style="padding: 50px 0;padding-bottom: 200px;background-color #121212;color: #fff;">
            <div class="fromright" style="max-width: 600px;margin: 0 auto;padding: 0 50px;">
                ...
                <p class="auto-style1">
                <asp:Image id="CZ" runat="server" ImageUrl="~/images/Czhibis_logo_1280w.jpg" ImageAlign="Middle" Width="60%"/>       
                </p>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sample 03.aspx.cs" Inherits="aspwebsite.Sample_03" %>
...
class="body-style">
     ...
     <form id="form1" runat="server" class="project_content">
          <iframe frameborder="0" width=100% height="450" src="http://www.youtube.com/embed/4GvqCzxai7M?autoplay=1" class="auto-style1"> </iframe>

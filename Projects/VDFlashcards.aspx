...
class="body-style">
     ...
     <form id="form1" runat="server" class="project_content">
        ...
        <div class="text1"  id="fade1" style="display:none;"   > 
                        ...
                        PROJECT: VirtualDeck Flashcards 
                        </br>
                        </br>
                        PLATFORMS: Android
                        </br>
                        </br>
                        STATUS: Released August 2013 and available around the world 
                        </br>
                        </br>
                        CONTRIBUTORS: Allen Smith (Visual Design and Programming), Pamela Espinosa (Visual Design), Daniel Smith (Promo Video) 
                        </br>
                        </br>
                        LINKS: Google Play (paid edition):&nbsp; 
            ...
            <div class="text1"  id="fade2" style="display:none;" > 
                        SUMMARY: VirtualDeck Flashcards is a native Android flashcard style study tool designed for students who need to study on the go. It allows you to organize your flashcards into categories (called virtual decks), as well as add images, audio, and import excel (or other spreadsheet software) files. No internet connection is required to study your decks. You can type up your notes using Google docs following a basic format (see virtualdeckflashcards.com for details) and save your notes to your phone, and then study on your way home from class, or heading to your next one. Image support is available for quickly adding formulas or hard to type up info. Just write it out on paper, take a picture with your phone, and then add it to your card. Random card order is now also supported.
